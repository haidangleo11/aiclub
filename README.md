...
Có thể mở trực tiếp `index.html` hoặc sử dụng **Live Server** trong VS Code.
...
Mỗi khi repository được cập nhật, website có thể được cập nhật thông qua GitHub Pages.
...
Một số mục tiêu trong tương lai:

* [ ] Hoàn thiện website chính thức của CLB
